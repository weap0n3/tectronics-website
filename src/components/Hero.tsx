  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-hero">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-gaming/20 rounded-full blur-3xl animate-glow" style={{ animationDelay: "1s" }} />
      </div>
      ...
      <div className="container mx-auto px-4 pt-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center animate-fade-in">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-secondary/50 backdrop-blur-sm border border-border mb-8">
            ...
            <span className="text-sm text-muted-foreground">Übungsfirma der HAK Zell am See</span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Deine Plattform für Gaming und Technologie. Wir simulieren echte Geschäftsprozesse und bieten innovative Lösungen.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Button size="lg" className="bg-gradient-primary shadow-glow hover:shadow-glow hover:scale-105 transition-all">
