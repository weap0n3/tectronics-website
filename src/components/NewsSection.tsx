	...
	const news = [
		{
			...
			description:
				'Die neuesten Next-Gen Konsolen sind jetzt bei Game Garage verfügbar. Sichere dir jetzt dein Exemplar!',
		...
		},
		{
			...
			description:
				'Cable-Corner erweitert die Server-Kapazitäten für noch bessere Performance und Zuverlässigkeit.',
		...
		},
		{
			...
			description:
				'TecTronics setzt auf papierlose Prozesse und umweltfreundliche Verpackungen.',
